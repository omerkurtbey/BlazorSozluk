...
namespace BlazorSozluk.Infrastructure.Persistence.Context
{
    public class BlazorSozlukContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                var connStr = "Server = DESKTOP-F2R4JB0\\MSSQLKD7; Database=blazorsozluk; Integrated Security=true";
        ...
        {
            var addesEntities = ChangeTracker.Entries()
                                           .Where(i => i.State == EntityState.Added)
                                           .Select(i => (BaseEntity)i.Entity);

            PrepareAddedEntities(addesEntities);
        }
